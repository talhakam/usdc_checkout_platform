...
var redis = new redis_1.Redis({ url: redisUrl, token: redisToken });
function testRedis() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    // Set a key
                    return [4 /*yield*/, redis.set('nextjs_test_key', 'Hello from Next.js + Upstash!')];
                case 1:
                    // Set a key
                    _a.sent();
                    return [4 /*yield*/, redis.get('nextjs_test_key')];
                case 2:
                    value = _a.sent();
                    console.log('Redis value:', value);
                    // Delete the key
                    return [4 /*yield*/, redis.del('nextjs_test_key')];
                case 3:
                    // Delete the key
                    _a.sent();
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('Redis test failed:', error_1);
                    process.exit(1);
                    return [3 /*break*/, 5];
